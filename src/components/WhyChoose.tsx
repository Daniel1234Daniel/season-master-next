...
<div className='flex flex-row h-full w-full'>
  <div className=" border-r border-[1.4px] hidden md:block border-gray-800 mr-0 md:mr-4 h-auto "></div>

  <div className="flex flex-col justify-evenly h-full gap-6 px-2">
    <div className='bg-[#26C7BE] p-4 rounded-lg max-w-[26rem]'>
